...
function salvarCliente() {
    ...
    // Adiciona o arquivo (logotipo), se presente
    ...
    fetch(url, {
        ...
        .then(() => {
            mostrarMensagem(clienteId ? "Cliente atualizado com sucesso!" : "Cliente salvo com sucesso!", 'sucesso');
            setTimeout(() => {
        ...
        .catch((error) => {
            ...
            mostrarMensagem("Erro ao " + (clienteId ? "atualizar" : "salvar") + " cliente", 'erro');
        })
        .finally(() => {
            mostrarCarregamento(false);
        });
